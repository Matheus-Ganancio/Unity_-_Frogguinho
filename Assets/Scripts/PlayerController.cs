...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else
        {
            ...
            // faz o player ir um pouco pra tras (feed back visual que pode ser ajustado para tras ou para frente
            // com o resultado do multiplicador de "knockbackSpeed" abaixo) quando sofre o dano sem ter o
            // controle do personagem, importante pra nao manter ele em alguma area que cause dano e ao mesmo
            // tempo que ele não use a invencibilidade ao sofrer dano para ultrapassar alguma coisa de forma idesejada
    ...
    {
        // usa a velocidade no vector2 para que o player de um pequeno pulo ao sofrer dano 
